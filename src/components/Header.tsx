      ...
      >
       ...
       <div className="flex items-center gap-2 md:gap-4">
        ...
        {deferredPrompt && (
          <button 
            onClick={onInstall}
            className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-600 hover:bg-emerald-700 transition-all active:scale-95 text-white text-[10px] font-black uppercase tracking-widest cursor-pointer shadow-lg shadow-emerald-900/20"
          >
